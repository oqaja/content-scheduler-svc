 ...
 *   1. Baca YT_CLIENT_ID / YT_CLIENT_SECRET dari dfm-youtube/.env
 *   2. Buka authorization URL Google OAuth di browser (scope YouTube Data)
 ...
 *   5. Update YT_REFRESH_TOKEN di dfm-youtube/.env lokal (baris lain gak disentuh)
 *   6. Jalanin `gh secret set` buat update secret DFM_YT_REFRESH_TOKEN di GitHub
...
// Scope disamakan dengan operasi yang dipakai runtime (src/lib/youtubePublisher.js):
...
// (mt-youtube, fap-youtube) yang hidup di repo yang sama.
const GITHUB_SECRET_NAME = "DFM_YT_REFRESH_TOKEN";
const GITHUB_REPO = "oqaja/content-scheduler-svc";

// Nama env var refresh token di dfm-youtube/.env.
const ENV_REFRESH_KEY = "DFM_YT_REFRESH_TOKEN";
