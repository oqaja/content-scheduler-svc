 ...
 *   1. Baca YT_CLIENT_ID / YT_CLIENT_SECRET dari mt-youtube/.env
 ...
 *   5. Update YT_REFRESH_TOKEN di mt-youtube/.env lokal (baris lain gak disentuh)
 *   6. Jalanin `gh secret set` buat update secret MT_YT_REFRESH_TOKEN di GitHub
...
// (dfm-youtube, fap-youtube) yang hidup di repo yang sama.
const GITHUB_SECRET_NAME = "MT_YT_REFRESH_TOKEN";
const GITHUB_REPO = "oqaja/content-scheduler-svc";

// Nama env var refresh token di mt-youtube/.env.
const ENV_REFRESH_KEY = "MT_YT_REFRESH_TOKEN";
