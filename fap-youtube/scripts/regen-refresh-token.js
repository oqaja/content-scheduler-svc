 ...
 *   1. Baca YT_CLIENT_ID / YT_CLIENT_SECRET dari fap-youtube/.env
 ...
 *   5. Update YT_REFRESH_TOKEN di fap-youtube/.env lokal (baris lain gak disentuh)
 *   6. Jalanin `gh secret set` buat update secret FAP_YT_REFRESH_TOKEN di GitHub
...
// (mt-youtube, dfm-youtube) yang hidup di repo yang sama.
const GITHUB_SECRET_NAME = "FAP_YT_REFRESH_TOKEN";
const GITHUB_REPO = "oqaja/content-scheduler-svc";

// Nama env var refresh token di fap-youtube/.env.
const ENV_REFRESH_KEY = "FAP_YT_REFRESH_TOKEN";
